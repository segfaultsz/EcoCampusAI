  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      <AreaChart data={data}>
        ...
        <Area type="monotone" dataKey="lower" stroke="none" fill="#3E3E3E" fillOpacity={0.2} />
        <Area type="monotone" dataKey="upper" stroke="none" fill="#3E3E3E" fillOpacity={0.2} />
        <Line type="monotone" dataKey="actual" stroke="#F26415" strokeWidth={2} name="Actual" />
        <Line type="monotone" dataKey="predicted" stroke="#3E3E3E" strokeWidth={2} strokeDasharray="5 5" name="Predicted" />
      </AreaChart>
    </ResponsiveContainer>
  );
}
